...
def pic2html(model_file_path, img_path, cuda=True, img_crop_size=224):
    ...
    display(HTML(predicted_html_string))
    print(predicted_html_string)

    return predicted_html_string

pic2html("E:\\Projects\\Final project\\New folder\\Final-Year-Project\\NeuroSketch\\NeuroSketch-pytorch\\models\\e-d-model--epoch-49--loss-0.0096--batch-4--time-18-04-08-54.pth","E:\\Projects\\Final project\\New folder\\Final-Year-Project\\NeuroSketch\\NeuroSketch-pytorch\\351.png")
